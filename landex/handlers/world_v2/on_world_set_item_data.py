...
async def on_world_set_item_data(
    ...
    place = await models.PlaceToken.get(token_id=int(set_item_data.parameter.chunk_key.place_key.id), contract=set_item_data.parameter.chunk_key.place_key.fa2)
